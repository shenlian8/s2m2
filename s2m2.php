...
#第三版说明
#说起来，我已经不记得，上次修改这个程序，是哪一年了。
#也忘记了这个程序是哪一年写的了。一晃到了今天，真正是“曾几何时”啊。
#曾经有人，把这个程序的第一版收到了他的书里。我碰巧在书店里看到。
#于是我给他写了封邮件，向他索要样书。他很爽快地答应了。这是快乐的经历。
#也有网站，把这个程序收到他们的程序库里，还声明版权归他们所有。
#更过分的是，他们竟给我写了封邮件，警告我侵犯他们的版权。
#不过此类宵小，如今已经灰飞烟灭了。而我，还在维护着这个程序。
#这也是快乐的经历。但愿我们能长久相伴。
#今年是2026年，是我的AI元年。我从年初开始接触AI。
#今天是4月20日。我用AI帮我重构了这个程序。
#PHP升级到什么版本，我也搞不清了，只知道AI说，我写的冗长的代码，
#现在可以用更简洁的方式实现。我只是按了同意按钮，于是就成了现在这个样子。
#当然，AI也帮我将这个程序改写成了Python版本。又做成了SKILL，以便AI Agent调用。
#这样我也赶上了AI的潮流。
#最后写点什么祝福呢？祝愿大家趁着大好的时代，把日子越过越好！
#也祝愿我们人类能够不断地发展壮大，长久地，快乐地在地球上，在宇宙中，生活下去！
#——上面的这段话，是我自己动手写的。致不知道什么时候再读到这段话的我自己。
##################################################
...
class S2M
{
  ...
  {
    if ($y < $this->MinYear or $y > $this->MaxYear)
      die('wrong time');
  ...
  */
  public function getMDate($y, $m, $d)
  {
    ...
    while ($j <= 200) {  //用农历的天数累加来判断是否超过阳历的天数
      $i = 1;
      while ($i <= 13) {
        if ($this->everymonth[$j][$i] != 29 && $this->everymonth[$j][$i] != 30 && $this->everymonth[$j][$i] != 0)
          die($j . '-' . $i . '-' . 'days check wrong.');
...
<body text="#008000">
      ...
      <table border="1" width="85%">
        <tr>
          <td align="center" bgcolor="#CCCCCC">
            <font size="4" color="#FF0000"><b>星期日</b></font>
          </td>
          <td width="14%" align="center" bgcolor="#CCCCCC">
            <font color="#000000" size="4"><b>星期一</b></font>
          </td>
          <td width="14%" align="center" bgcolor="#CCCCCC">
            <font color="#000000" size="4"><b>星期二</b></font>
          </td>
          <td width="14%" align="center" bgcolor="#CCCCCC">
            <font color="#000000" size="4"><b>星期三</b></font>
          </td>
          <td width="14%" align="center" bgcolor="#CCCCCC">
            <font color="#000000" size="4"><b>星期四</b></font>
          </td>
          <td width="14%" align="center" bgcolor="#CCCCCC">
            <font color="#000000" size="4"><b>星期五</b></font>
          </td>
          <td width="14%" align="center" bgcolor="#CCCCCC">
            <font size="4" color="#008000"><b>星期六</b></font>
          </td>
  ...
  ?>
  <p align="center">
    <font color="#000000">年份：</font><select size="1" name="year">
      <?php
    ...
    <font color="#000000">
      月份：<select size="1" name="month">
        ...
        ?>
      </select>月 </font><input type="submit" value="查询" name="B1">
  </p>
  </form>
</body>
